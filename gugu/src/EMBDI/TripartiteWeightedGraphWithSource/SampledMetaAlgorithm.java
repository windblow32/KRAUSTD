...
public class SampledMetaAlgorithm {
    ...
    public List<String> Meta_Algorithm(List<String> fileList, int n_walks, int n_nodes, int length) {
        ...
        GenerateSampledTripartite graph = new GenerateSampledTripartite();
        graph = graph.generateSourceTripartiteGraph(fileList);
        GenerateSampledTripartiteRandomWalk walkGraph = new GenerateSampledTripartiteRandomWalk(graph);
