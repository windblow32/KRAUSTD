package main.java.ctd.weather.nopenalty;
...
public class GAImpl_nop extends GeneticAlgorithm {
...
//        NormalizeDistributeRunInGA obj = new NormalizeDistributeRunInGA();
        ...
        if(version == 1&&existDA==1){
            ...
            // add DA
            CTD_Algorithm_nop DA_CTDService = new CTD_Algorithm_nop();
...
//            kTrace();
    ...
    @Test
    public void test(){
        GAImpl_nop gaImplTest = new GAImpl_nop();
