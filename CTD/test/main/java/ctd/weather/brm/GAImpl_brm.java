...
public class GAImpl_brm extends GeneticAlgorithm {
...
//        NormalizeDistributeRunInGA obj = new NormalizeDistributeRunInGA();
        ...
        CTD_Algorithm_brm CtdService = new CTD_Algorithm_brm();
        // 数据集列表
        ...
        if(version == 1&&existDA==1){
            ...
            // add DA
            CTD_Algorithm_brm DA_CTDService = new CTD_Algorithm_brm();
...
//            kTrace();
    ...
    @Test
    public void test(){
        GAImpl_brm gaImplTest = new GAImpl_brm();
