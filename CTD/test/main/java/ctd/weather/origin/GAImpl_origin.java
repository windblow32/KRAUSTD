...
import main.java.ctd.weather.all.CTD_Algorithm_all;
...
public class GAImpl_origin extends GeneticAlgorithm {

    // debug use
    // fixme : change source
    public String dataPath = "data/new_weather/20,35,17.5";
    // log file to store
    public String log = "log/Tri/CTD/weather/parameter";

    public int existDA = 1;
    // fixme : change source 标注数
    public int biaozhushu = 13;
    public int zengqiangshu = 183;
    public int D1;
    public int D2;
...
//        NormalizeDistributeRunInGA obj = new NormalizeDistributeRunInGA();
        ...
        CTD_Algorithm_origin CtdService = new CTD_Algorithm_origin();
        // 数据集列表
        ...
        if(version == 1&&existDA==1){
            ...
            // add DA
            CTD_Algorithm_all DA_CTDService = new CTD_Algorithm_all();
        ...
        // fixme : only ctd change last parmeter to 0
...
//        extractedCTD_RMSE = CtdService.getRmseForGA();
        ...
        // fixme : log path
        String logPath = log + "/log" + insertT1 + ".txt";
...
//            kTrace();
    ...
    @Test
    public void test(){
        GAImpl_origin gaImplTest = new GAImpl_origin();
