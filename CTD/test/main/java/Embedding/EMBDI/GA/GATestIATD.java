...
public class GATestIATD extends GeneticAlgorithm{
...
//            resultFilePath = "data/ctd/monitor/result/DAresult/result_" + "DA" + ".csv";
    ...
    public void getTempDA(){
        // 写入的路径
        String tempDAFilePath = "data/iatd/monitor/tempDA.csv";
        if(isDA==0){
            // 拿到需要修改的数据
            ...
            try {
                ...
                daTupleList.add("193");
                // fixme : 用置信度最强的修复？
                File truthFile = new File("data/iatd/monitor/source/source4.csv");
    ...
    @Test
    public void test(){
        GATestIATD gaImplTest = new GATestIATD();
