...
public class GATestIATD_Camera extends GeneticAlgorithm{
...
//            }
            IATD iatd = new IATD();
            IATDModel = iatd.iatdUseDA_camera(length,20000,AttrDistributeLow,
                    AttrDistributeHigh,
                    ValueDistributeLow,
                    ValueDistributeHigh,
                    TupleDistributeLow,
            ...
            File exitBound = new File("log/Tri/IATD/exitBound.txt");
            try {
                FileReader fr = new FileReader(exitBound);
...
//        }
        // run dart
        IATD iatd = new IATD();
        IATDModel = iatd.iatdUseOrigin_camera(length,20000,AttrDistributeLow,
                AttrDistributeHigh,
                ValueDistributeLow,
                ValueDistributeHigh,
                TupleDistributeLow,
...
//            System.out.println("R square GA : " + r2);
        ...
        String judgeFuncFile = "data/iatd/monitor/rmseFile.txt";
        ...
        int nextVersion = 0;
        String version_list_path = "data/iatd/monitor/version.txt";
...
//            resultFilePath = "data/ctd/monitor/result/DAresult/result_" + "DA" + ".csv";
        ...
        if(isDA == 0){
            ...
            // monitor
            truthFilePath = "data/iatd/camera/camera_truth.csv";
    ...
    public void getTempDA(){
        // 写入的路径
        String tempDAFilePath = "data/iatd/camera/tempDA.csv";
        if(isDA==0){
            // 拿到需要修改的数据
            ...
            try {
                ...
                daTupleList.add("570");
                // fixme : 用置信度最强的修复？
                File truthFile = new File("data/iatd/camera/source/source4.csv");
    ...
    @Test
    public void test(){
        GATestIATD_Camera gaImplTest = new GATestIATD_Camera();
