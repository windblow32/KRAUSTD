...
public class IATD_Bayes {
    ...
    public void run() throws IOException {
        ...
        for (int version = 1; version < 10; version++) {
            ...
            calcTruthPath = "E:\\GitHub\\KRAUSTD\\IATD\\" + version + "_truth.csv";
            IATD iatd = new IATD();
            iatd.sourceNum = sourceNum;
            iatd.tupleNum = D1;
            iatd.dataPath = dataPath;
            ...
            Process iatdProc;
            try {
                iatdProc = Runtime.getRuntime().exec("python E:\\GitHub\\KRAUSTD\\IATD\\main.py");// 执行py文件
                //用输入输出流来截取结果
                BufferedReader in = new BufferedReader(new InputStreamReader(iatdProc.getInputStream()));
                String line = null;
                while ((line = in.readLine()) != null) {
                    System.out.println(line);
                }
...
//        extractedCTD_RMSE = CtdService.getRmseForGA();
            ...
            // attention : log path
            String logPath;
            logPath = "log/Tri/IATD/monitor/parameter/log" + insertT1 + ".txt";
            ...
            try {
                ...
                System.setOut(logps);
                if (version == 1) {
                    System.out.println("DA过程的时间 : " + t_DApre + " 至 " + t_DAafter);
                }
