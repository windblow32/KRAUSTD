package main.java.embdiTest.CTD.embdi;
...
public class GA_CTD_embdi extends GeneticAlgorithm {
    ...
    public double calculateY(Chromosome chro) {
        ...
        initParameter();
        initMultipleList();
        CTD_Algorithm_embdi CtdService = new CTD_Algorithm_embdi();
        // 数据集列表
        ...
        if (version == 1 && existDA == 1) {
            ...
            // add DA
            CTD_Algorithm_embdi DA_CTDService = new CTD_Algorithm_embdi();
...
//            String filePath = "data/ctd/monitor/sourceDA/source" + temp + ".csv";
    ...
    public void test() throws IOException {
        GA_CTD_embdi gaImplTest = new GA_CTD_embdi();
