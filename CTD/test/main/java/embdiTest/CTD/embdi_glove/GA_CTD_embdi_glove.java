...
public class GA_CTD_embdi_glove extends GeneticAlgorithm {
    ...
    public double calculateY(Chromosome chro) {
        ...
        initParameter();
        initMultipleList();
        CTD_Algorithm_embdi_glove CtdService = new CTD_Algorithm_embdi_glove();
        // 数据集列表
        ...
        if (version == 1 && existDA == 1) {
            ...
            // add DA
            CTD_Algorithm_embdi_glove DA_CTDService = new CTD_Algorithm_embdi_glove();
...
//            String filePath = "data/ctd/monitor/sourceDA/source" + temp + ".csv";
    ...
    public void test() throws IOException {
        GA_CTD_embdi_glove gaImplTest = new GA_CTD_embdi_glove();
