package main.java.embdiTest.DART.embdi;
...
public class GA_dart_embdi extends GeneticAlgorithm {
...
//        NormalizeDistributeRunInGA obj = new NormalizeDistributeRunInGA();
        ...
        if (version == 1 && existDA == 1) {
            ...
            DART_embdi dart = new DART_embdi();
...
//            resultFilePath = "data/ctd/monitor/result/DAresult/result_" + "DA" + ".csv";
    ...
    @Test
    public void test() {
        GA_dart_embdi gaImplTest = new GA_dart_embdi();
