...
public class GA_iatd_all extends GeneticAlgorithm {

    // fixme : 如果sourceDA是空的就置0
    public int existDA = 1;
    // fixme : sizeof(threetruth) -1
    public int biaozhushu = 183;
    public int D1 = 150;
    public int D2 = 5;
...
//        NormalizeDistributeRunInGA obj = new NormalizeDistributeRunInGA();
        ...
        if(existDA==1){
            ...
            String daSet = "data/new_weather/15_30_9.0/sourceDA/source1.csv";
...
//        extractedCTD_RMSE = CtdService.getRmseForGA();
        ...
        // fixme log path
        String logPath = "log/Tri/IATD/weather/parameter/log" + insertT1 + ".txt";
...
//            System.out.println("R square GA : " + r2);
        ...
        String judgeFuncFile = "data/iatd/weather/rmseFile.txt";
        ...
        int nextVersion = 0;
        String version_list_path = "data/iatd/weather/version.txt";
        ...
        try {
            ...
            if(version >= 2){
                ...
                if(index <= 1){
                    ...
                    // read rmseList
                    String rmseStoreFile = "data/iatd/weather/rmseFile.txt";
...
//            Collections.sort(rmseList);
                        ...
                        try{
                            ...
                            for(int s1 = 1;s1<sourceNum;s1++){
                                for(int s2 = s1 + 1;s2<=sourceNum;s2++){
                                    ...
                                    double detaWeight = 0;
                                    try{
                                        detaWeight = Math.abs(distanceUseSavedModel(IATDModel,sourceP,sourceQ));
    ...
    private void saveDA(int D1, int D2, String path) {
        ...
        File saveFile = new File("data/new_weather/15_30_9.0/da1_order.csv");
    ...
    private List<String> initialFileListDA(String dataset) {
        ...
        if(dataset.equals("monitor")){
            ...
            for (int i = 1; i <= sourceNum; i++) {
                // fixme : step 2
                String filePath = "data/new_weather/15_30_9.0/sourceDA/source" + i + ".csv";
                fileListDA.add(filePath);
            }
        }
    ...
    public List<String> initialFileList(String dataset){
        ...
        if(dataset.equals("weather")){
            for (int i = 1; i <= sourceNum; i++) {
                // fixme : step 9
                String filePath = "data/new_weather/15_30_9.0/source/source" + i + ".csv";
    ...
    public String[][] readGoldStandard(int D1, int D2){
        ...
        // fixme : step 8
        String goldenStandardPath = "data/new_weather/15_30_9.0/threetruth.csv";
        try {
...
//            truthFilePath = "data/dart/monitor/monitor_truth.csv";
            ...
            truthFilePath = "data/new_weather/15_30_9.0/threetruth-weather15,30,9.0.csv";
    ...
    public void getTempDA(){
        ...
        if(isDA==0){
            ...
            try {
                ...
                File truthFile = new File("data/new_weather/15_30_9.0/source/source4.csv");
    ...
    @Test
    public void test(){
        GA_iatd_all gaImplTest = new GA_iatd_all();
